-------------------------------------------------------------------------------
--
-- sm_midl.as: Degree-lexicographical exponent vectors 
--               of machine integers.
--
--------------------------------------------------------------------------------
...
-- ext MachineIntegerDegreeLexicographicalExponent
...
+++ `MachineIntegerDegreeLexicographicalExponent(V)' implements the 
...
+++ `firstIndex..lastIndex' after comparing the total degrees of `a' and `b').
+++ Author: Marc Moreno Maza
+++ Date Created: 09/07/01
+++ Date Last Update: 12/07/01


MachineIntegerDegreeLexicographicalExponent(V: FiniteVariableType): 
